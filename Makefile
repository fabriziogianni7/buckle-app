...
install :; forge install foundry-rs/forge-std --no-commit && forge install openzeppelin/openzeppelin-contracts --no-commit && forge install smartcontractkit/chainlink-local  --no-commit && forge install smartcontractkit/ccip@v2.10.0-ccip1.4.12  --no-commit
