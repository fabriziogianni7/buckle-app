        ...
        <div className="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 opacity-0 ease-out transition-all sm:max-w-lg sm:w-full m-3 sm:mx-auto min-h-[calc(100%-3.5rem)] flex items-center">
            <div className="flex flex-col bg-white border shadow-sm rounded-xl pointer-events-auto dark:bg-neutral-800 dark:border-neutral-700 dark:shadow-neutral-700/70">
                <div className="flex justify-between items-center py-3 px-4 border-b dark:border-neutral-700">
                    ...
                    <button type="button" className="flex justify-center items-center size-7 text-sm font-semibold rounded-full border border-transparent text-gray-800 hover:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none dark:text-white dark:hover:bg-neutral-700" data-hs-overlay="#deposit-modal">
                ...
                <div className="p-4 overflow-y-auto">
                    {
                        ...
                        <div>
                            ...
                            <p className="mt-1 text-gray-800 dark:text-neutral-400">
                                In exchange you're going to get LPT tokens representing your stake in the pool.
                            </p>
                            <p className="mt-1 text-gray-800 dark:text-neutral-400">
                                You are going to pay {ccipFees as bigint ? formatEther(ccipFees as bigint) : 0} native tokens to deposit, in order to send a message crosschain
                            </p>
                            <p className="mt-1 text-gray-800 dark:text-neutral-400">
                                maybe here I want to see how many LPT I get back
                            </p>
                        </div>
                    }
                    {
                            ...
                            <div className="flex p-4">
                                ...
                                <div className="ms-3">
                                    <p className="text-sm text-gray-700 dark:text-neutral-400">
                                        You successfully deposited into the pool.
                                        tx hash: {hash}
                ...
                <div className="flex justify-end items-center gap-x-2 py-3 px-4 border-t dark:border-neutral-700">
                    <button type="button" className="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-white dark:hover:bg-neutral-800" data-hs-overlay="#deposit-modal">
                        Close
                    </button>
                    < button type="button" disabled={isConfirming} className="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none"
